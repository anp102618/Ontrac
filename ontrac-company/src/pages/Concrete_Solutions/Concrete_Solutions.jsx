...
export default function ConcreteSolutions() {
  return (
    ...
    >
      ...
      <section className="concrete-solutions-hero">

        <div className="concrete-solutions-hero-copy">

          <h1>
            <span className="concrete-black">
              Concrete
            </span>

            <span className="concrete-blue">
              Solutions
            </span>
          </h1>

          <p>
            Reliable concrete and structural materials designed to provide
            strength, durability, consistency, and long-term performance for
